...
int main() {
	...
	cout << not_fn(less<int>())(10,20) << endl;
	//cout << not2(less<int>()(20, 20)) << endl;
	cout << not_fn(less<int>())(20, 20) << endl;
	//cout << not2(less<int>()(20, 10)) << endl;
	cout << not_fn(less<int>())(20, 10) << endl;
	cout << endl;
	...
	cout << not_fn(l)(10, 20) << endl;
	//cout << not2(l)(20, 20) << endl;
	cout << not_fn(l)(20, 20) << endl;
	//cout << not2(l)(20, 10) << endl;
	cout << not_fn(l)(20, 10) << endl;
